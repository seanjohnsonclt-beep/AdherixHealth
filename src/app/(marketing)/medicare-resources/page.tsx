    ...
    <div className="med-page">
      ...
      <section className="mkt-section mkt-section--alt med-section">
        <div className="mkt-container">
          ...
          <h2 className="mkt-h2 med-section__title">Free provider resources</h2>
          ...
          <p className="med-resource-group-label" style={{ marginTop: '32px' }}>Official CMS documents</p>
      ...
      {/* -- What providers need to know (accordion) ------------- */}
      <section className="mkt-section med-section">
        <div className="mkt-container">
          <span className="mkt-eyebrow">How the program works</span>
          <h2 className="mkt-h2 med-section__title">What providers need to know</h2>
          <AccordionSection />
        </div>
      </section>

      {/* -- Adherix Bridge Support (condensed) ------------------ */}
      <section className="mkt-section mkt-section--alt med-section">
        <div className="mkt-container">
          <span className="mkt-eyebrow">Adherix bridge support</span>
          <h2 className="mkt-h2 med-section__title">We help clinics operationalize the Bridge</h2>
          <div className="med-support-grid">
            <div className="med-support-item">
              ...
              <div>
                ...
                <p>Walk through your workflow and close gaps before July 1 - so first submissions go through cleanly.</p>
              </div>
            </div>
            <div className="med-support-item">
              ...
              <div>
                ...
                <p>Identify which patients in your panel likely qualify so you can prioritize outreach before demand surges.</p>
              </div>
            </div>
            <div className="med-support-item">
              ...
              <div>
                ...
                <p>Map the journey from eligibility to first prescription - so front desk and clinical staff know exactly what happens when.</p>
              </div>
            </div>
            <div className="med-support-item">
              ...
              <div>
                ...
                <p>One page covering PA submission, patient communication, and documentation - ready to run before July 1.</p>
              </div>
            </div>
          </div>
        </div>
